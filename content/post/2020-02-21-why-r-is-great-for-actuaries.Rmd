...
There are different IT tools in different areas.

The actuarial reporting process can be divided into the following areas:

![](https://raw.githubusercontent.com/zchmielewska/actuaryr-webpage/master/content/img/actuarial-reporting.png)
